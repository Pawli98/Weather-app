...
{
    private static final String WEATHER_map_URL="https://api.openweathermap.org/data/2.5/weather?lat=%s&lon=%s&units=metric";
    private static final String WEATHER_map_API="fef7278a62fbb00746a9072ca1dc0db4";
        ...
        mFusedLocationProviderClient.getLastLocation().addOnSuccessListener(MainActivity.this, new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location)
            {
                if(location!=null)
                {
                    ...
                    humidityField.setText("Wilgotność: "+ jsonData[3]);
                    pressureField.setText("Ciśnienie: "+jsonData[4]);
    ...
    public String[] getJSONResponse()
    {
        ...
        {
            Log.d("Error","Can not process JSON results",e);
        }
        ...
        try {
            if (jsonWeather!= null)
            {
               ...
               JSONObject main=jsonWeather.getJSONObject("main");
                ...
                String description=details.getString("description").toLowerCase(Locale.UK);
    ...
    public static  String setWeatherIcon(int actualId,long sunrise,long sunset)
    {
        ...
        if(actualId==800)//tu
        {
            ...
            {
                icon = "&#xf00d;";
                //icon = Long.toString(R.drawable.wi_day_sunny);
            }
            else
                {
                icon = "&#xf02e;";
    ...
    {
        try{
            URL url=new URL(String.format(WEATHER_map_URL,lat,lon));
